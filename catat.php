...
$username = "tesr3386_admintcr";
$password = "W-v-c0M!-alf";
$dbname = "tesr3386_stickynotes";
$max_retries = 3;
...
<body>
    <a href="?logout=true" style="position: absolute; top: 20px; right: 20px; padding: 10px; background-color: #e53935; color: white; border-radius: 5px;">Logout</a>
    <div class="header">
        <h1>CATATAN</h1>
